...
The results of my thesis will contribute significantly to the understanding of low-energy effective interactions in single and bilayer graphene, and will provide a baseline for a continuing study of the twisted bi-layer graphene (TBLG) system.
...
Minimal many-body models like the Hubbard \cite{Hubbard1963}, Kanamori \cite{10.1143/PTP.30.275},  and t-J \cite{Chao_1977} models have been proposed to describe such systems.
However, their effectiveness in describing realistic materials is unclear as they have no direct link to the \textit{ab initio} Hamiltonian.
...
In the next steps of the project I will address this question by demonstrating the unique interpretability of a model.
I plan on accomplishing this by refitting my model after dropping specific interactions, like $n_{4s,\uparrow} n_{4s,\downarrow}$, and quantitatively evaluating the effect on the model spectra, eigenstates, and renormalization of non-interacting parameters.
...
Quantitative details of the interlayer coupling spatial dependence, which are intimately related to the strongly correlated behavior in TBLG, can also begin to be addressed.
