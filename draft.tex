...
The following set of 1- and 2-body operators were selected as candidates for the model based on understanding of the low-energy excitations of the CuO molecule and properties of the sampled low-energy states:
\begin{equation}
\begin{split}
...
The term $\sum_{i\in {\{\text{xy, xz, ...}}\}} \vec{S}_{4s} \cdot \vec{S}_{3d_i}$ was also considered, motivated by the existence of a $\sim $0.5 eV Hund's coupling observed on the copper atom \textbf{ref}.
...
The effective on-site Coulomb repulsion $U_s$ can ensure our model places all $4s^{2}$ states high in energy.
...
To reduce multicollinearity while maintaining a high goodness of fit, I fit a model to these nine PCs.
