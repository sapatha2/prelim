...
The effective on-site Coulomb repulsion $U_s$ ensures the model places all $4s^{2}$ states high in energy.
...
To reduce multicollinearity while maintaining a high goodness of fit, model was fit to these nine PCs.
