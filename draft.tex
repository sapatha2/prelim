...
Throughout this proposal $\hat{H}$ is the \textit{ab-initio} Hamiltonian under the Born-Oppenheimer approximation
\begin{equation}
...
Second, the method should be relatively inexpensive, as large amounts of training data is preferred for a more robust regression.
...
Feature selection methods for choosing descriptors from the candidate pool can range from wrapper methods like principal component analysis \cite{pearson_karl_1901_1430636} to regularized embedded methods LASSO \cite{10.2307/2346178, doi:10.1137/S0895479897326432, Zou05regularizationand}. 
